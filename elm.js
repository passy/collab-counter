...
Elm.ElmFire.Dict.make = function (_elm) {
   ...
   if (_elm.ElmFire.Dict.values)
   return _elm.ElmFire.Dict.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "ElmFire.Dict",
   $Basics = Elm.Basics.make(_elm),
   ...
   var getValues = function (config) {
      return function () {
         var decodeValueList = $List.filterMap(function ($) {
            return $Result.toMaybe($Json$Decode.decodeValue(config.decoder)($));
         });
         return $Task.map(function ($) {
            return decodeValueList($ElmFire.toValueList($));
         })(A2($ElmFire.once,
   ...
   var getKeys = function (config) {
      return $Task.map($ElmFire.toKeyList)(A2($ElmFire.once,
      $ElmFire.valueChanged(config.orderOptions),
      config.location));
   };
   var getList = function (config) {
      return function () {
         var decodePairList = $List.filterMap(function (_v10) {
            return function () {
               switch (_v10.ctor)
               {case "_Tuple2":
                  return function () {
                       var _v14 = A2($Json$Decode.decodeValue,
                       config.decoder,
                       _v10._1);
                       switch (_v14.ctor)
                       {case "Err":
         ...
         return $Task.map(function ($) {
            return decodePairList($ElmFire.toPairList($));
         })(A2($ElmFire.once,
         $ElmFire.valueChanged(config.orderOptions),
         config.location));
      }();
   ...
   var getDict = function (config) {
      return $Task.map($Dict.fromList)(getList(config));
   };
   ...
   var Undecodable = F2(function (a,
   b) {
      return {ctor: "Undecodable"
             ,_0: a
             ,_1: b};
   });
   var Removed = F2(function (a,
   b) {
      return {ctor: "Removed"
             ,_0: a
             ,_1: b};
   });
   var Changed = F2(function (a,
   b) {
      return {ctor: "Changed"
             ,_0: a
             ,_1: b};
   ...
   var subscribeDelta = F2(function (addressee,
   config) {
      return function () {
         var subscribeEvent = F2(function (event,
         deltaOp) {
            ...
            function (snapshot) {
               ...
               addressee,
               function () {
                  var _v17 = A2($Json$Decode.decodeValue,
                  config.decoder,
                  snapshot.value);
                  switch (_v17.ctor)
                  {case "Err":
                     return A2(Undecodable,
                       snapshot.key,
                       _v17._0);
                     case "Ok": return A2(deltaOp,
                       snapshot.key,
                       _v17._0);}
                  _U.badCase($moduleName,
            ...
            function (cancellation) {
               ...
               addressee,
               function () {
                  switch (cancellation.ctor)
                  {case "QueryError":
                     return QueryError(cancellation._1);
                     case "Unsubscribed":
                     return Unsubscribed;}
                  _U.badCase($moduleName,
   ...
   _elm.ElmFire.Dict.values = {_op: _op
                              ,getDict: getDict
                              ,getList: getList
                              ,getKeys: getKeys
                              ,getValues: getValues
...
Elm.ElmFire.Op.make = function (_elm) {
   ...
   if (_elm.ElmFire.Op.values)
   return _elm.ElmFire.Op.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "ElmFire.Op",
   $Basics = Elm.Basics.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   $ElmFire = Elm.ElmFire.make(_elm),
   ...
   key) {
      ...
      function (maybeJsonVal) {
         return function () {
            switch (maybeJsonVal.ctor)
            {case "Just":
               return function () {
                    var _v2 = A2($Json$Decode.decodeValue,
                    config.decoder,
                    maybeJsonVal._0);
                    switch (_v2.ctor)
                    {case "Err":
                       ...
                       case "Ok": return function () {
                            var _v5 = A2(filterMapping,
                            key,
                            _v2._0);
                            switch (_v5.ctor)
                            {case "Just":
                               return $ElmFire.Set(config.encoder(_v5._0));
                               case "Nothing":
                               return $ElmFire.Remove;}
                            _U.badCase($moduleName,
                            "between lines 356 and 359");
                         }();}
                    _U.badCase($moduleName,
   ...
   maybeJsonDict) {
      return function () {
         switch (maybeJsonDict.ctor)
         {case "Just":
            return function () {
                 var _v9 = A2($Json$Decode.decodeValue,
                    ...
                    case "Ok": return function () {
                         ...
                         function (_v12) {
                            return function () {
                               ...
                               {case "_Tuple2":
                                  return function () {
                                       var _v16 = A2($Json$Decode.decodeValue,
                                       config.decoder,
                                       _v12._1);
                                       switch (_v16.ctor)
                                       {case "Err":
                 ...
                 _U.badCase($moduleName,
                 "between lines 331 and 347");
              }();
            case "Nothing":
            return $ElmFire.Abort;}
         _U.badCase($moduleName,
         "between lines 328 and 347");
      }();
   });
   var operateFilterElemT = F3(function (config,
   filter,
   key) {
      return A3($ElmFire.transaction,
      function (maybeJsonVal) {
         return function () {
            ...
            {case "Just":
               return function () {
                    var _v23 = A2($Json$Decode.decodeValue,
                    config.decoder,
                    maybeJsonVal._0);
                    switch (_v23.ctor)
                    {case "Err":
                       return $ElmFire.Abort;
                       case "Ok": return A2(filter,
                         key,
                         _v23._0) ? $ElmFire.Abort : $ElmFire.Remove;}
                    _U.badCase($moduleName,
                    "between lines 316 and 322");
                 }();
               case "Nothing":
               return $ElmFire.Abort;}
            _U.badCase($moduleName,
            "between lines 314 and 322");
         }();
      },
      A2($ElmFire.sub,
      key,
   ...
   maybeJsonDict) {
      return function () {
         ...
         {case "Just":
            return function () {
                 var _v28 = A2($Json$Decode.decodeValue,
                 $Json$Decode.keyValuePairs($Json$Decode.value),
                 maybeJsonDict._0);
                 switch (_v28.ctor)
                 {case "Err":
                    ...
                    case "Ok": return function () {
                         ...
                         function (_v31) {
                            return function () {
                               ...
                               {case "_Tuple2":
                                  return function () {
                                       var _v35 = A2($Json$Decode.decodeValue,
                                       config.decoder,
                                       _v31._1);
                                       switch (_v35.ctor)
                 ...
                 _U.badCase($moduleName,
                 "between lines 296 and 309");
              }();
            case "Nothing":
            return $ElmFire.Abort;}
         _U.badCase($moduleName,
         "between lines 293 and 309");
      }();
   });
   var operateMapElemT = F3(function (config,
   mapping,
   key) {
      return A3($ElmFire.transaction,
      function (maybeJsonVal) {
         return function () {
            ...
            {case "Just":
               return function () {
                    var _v40 = A2($Json$Decode.decodeValue,
                    config.decoder,
                    maybeJsonVal._0);
                    switch (_v40.ctor)
                    {case "Err":
                       return $ElmFire.Abort;
                       case "Ok":
                       return $ElmFire.Set(config.encoder(A2(mapping,
                         key,
                         _v40._0)));}
                    _U.badCase($moduleName,
   ...
   maybeJsonDict) {
      return function () {
         ...
         {case "Just":
            return function () {
                 var _v45 = A2($Json$Decode.decodeValue,
                 $Json$Decode.keyValuePairs($Json$Decode.value),
                 maybeJsonDict._0);
                 switch (_v45.ctor)
                 {case "Err":
                            ...
                            return function () {
                               ...
                               {case "_Tuple2":
                                  return {ctor: "_Tuple2"
                                         ,_0: _v48._0
                                         ,_1: function () {
                                            var _v52 = A2($Json$Decode.decodeValue,
                                            config.decoder,
                                            _v48._1);
                                            switch (_v52.ctor)
                                            {case "Err": return _v48._1;
                                               case "Ok":
                                               return config.encoder(A2(mapping,
                                                 _v48._0,
                                                 _v52._0));}
                                            _U.badCase($moduleName,
                                            "between lines 270 and 273");
                                         }()};}
                               _U.badCase($moduleName,
                 ...
                 _U.badCase($moduleName,
                 "between lines 262 and 277");
              }();
            case "Nothing":
            return $ElmFire.Abort;}
         _U.badCase($moduleName,
         "between lines 259 and 277");
      }();
   });
   var operateUpdateFun = F3(function (config,
   alter,
   maybeJsonVal) {
      return function () {
         switch (maybeJsonVal.ctor)
         {case "Just":
            return function () {
                 var _v57 = A2($Json$Decode.decodeValue,
                 config.decoder,
                 maybeJsonVal._0);
                 switch (_v57.ctor)
                 {case "Err":
                    return $ElmFire.Abort;
                    case "Ok": return function () {
                         var _v60 = alter($Maybe.Just(_v57._0));
                         switch (_v60.ctor)
                         {case "Just":
                            return $ElmFire.Set(config.encoder(_v60._0));
                            case "Nothing":
                            return $ElmFire.Remove;}
                         _U.badCase($moduleName,
                 ...
                 _U.badCase($moduleName,
                 "between lines 250 and 255");
              }();
            case "Nothing":
            return function () {
                 var _v62 = alter($Maybe.Nothing);
                 switch (_v62.ctor)
                 {case "Just":
                    return $ElmFire.Set(config.encoder(_v62._0));
                    case "Nothing":
                    return $ElmFire.Remove;}
                 _U.badCase($moduleName,
   ...
   var atomic = Atomic;
   var FilterMap = F2(function (a,
   b) {
      return {ctor: "FilterMap"
             ,_0: a
             ,_1: b};
   });
   ...
   var map = Map;
   var RemoveList = F2(function (a,
   b) {
      return {ctor: "RemoveList"
             ,_0: a
             ,_1: b};
   });
   var removeList = RemoveList;
   var InsertList = F2(function (a,
   b) {
      return {ctor: "InsertList"
             ,_0: a
             ,_1: b};
   });
   var insertList = InsertList;
   var FromList = F2(function (a,
   b) {
      return {ctor: "FromList"
             ,_0: a
             ,_1: b};
   });
   var fromList = FromList;
   var operate = F2(function (config,
   operation) {
      return function () {
         ...
         var dispatchTaskList = F2(function (dispatch,
         taskList) {
            return _U.eq(dispatch,
            Parallel) ? A2($Task.andThen,
            $Task.sequence(A2($List.map,
            $Task.spawn,
            taskList)),
            function (_v64) {
               return function () {
            ...
            function (_v68) {
               return function () {
                  ...
                  {case "_Tuple2":
                     return {ctor: "_Tuple2"
                            ,_0: _v68._0
                            ,_1: config.encoder(_v68._1)};}
                  _U.badCase($moduleName,
                  "on line 172, column 48 to 73");
               }();
            },
            pairs));
         };
         return function () {
            ...
            {case "Empty":
               return $ElmFire.remove(config.location);
               case "Filter":
               switch (operation._0.ctor)
                 {case "Atomic":
                    return transactionOp(A2(operateFilterTFun,
                      config,
                      operation._1));}
                 return A2($Task.andThen,
                 getKeys,
               ...
               return A2(operate,
                 ...
                 A2(FromList,
                 operation._0,
                 $Dict.toList(operation._1)));
               case "FromList":
               switch (operation._0.ctor)
                 {case "Atomic":
                    return A2($ElmFire.set,
                      encodePairs(operation._1),
                      config.location);}
                 return A2($Task.andThen,
               ...
               switch (operation._0.ctor)
                 ...
                 function (_v95) {
                    return function () {
                       ...
                       {case "_Tuple2":
                          return A2($ElmFire.set,
                            config.encoder(_v95._1),
                            A2($ElmFire.sub,
                            _v95._0,
                            config.location));}
                       _U.badCase($moduleName,
                       "on line 217, column 17 to 84");
                    }();
                 },
                 operation._1));
               case "Map":
               switch (operation._0.ctor)
                 {case "Atomic":
                    return transactionOp(A2(operateMapTFun,
                      config,
                      operation._1));}
                 return A2($Task.andThen,
                 getKeys,
               ...
               case "Push":
               return A2($ElmFire.set,
                 config.encoder(operation._0),
                 $ElmFire.push(config.location));
               case "Remove":
               return $ElmFire.remove(A2($ElmFire.sub,
                 operation._0,
                 config.location));
               case "RemoveList":
               switch (operation._0.ctor)
                 ...
                 operation._1));
               case "Update":
               return transactionOp(A2(operateUpdateFun,
                 config,
                 operation._1));}
            _U.badCase($moduleName,
            "between lines 191 and 242");
         }();
      }();
   });
   var forwardOperation = F2(function (taskAddressee,
   config) {
      return A2($Signal.forwardTo,
      taskAddressee,
      operate(config));
   });
   var FromDict = F2(function (a,
   b) {
      return {ctor: "FromDict"
             ,_0: a
             ,_1: b};
   });
   ...
   _elm.ElmFire.Op.values = {_op: _op
                            ,none: none
                            ,insert: insert
                            ,push: push
                            ,update: update
...
Elm.Main.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var voteToNum = function (v) {
      return function () {
         switch (v.ctor)
         {case "Downvote":
            return -1 * v._0;
            case "Upvote": return v._0;}
         _U.badCase($moduleName,
   ...
   var augment = function (model) {
      return function () {
         var count = A3($List.foldl,
         F2(function (a,b) {
            return b + voteToNum(a);
         }),
         0,
         $Dict.values(model.votes));
         return {_: {},voteCount: count};
      }();
   };
   var AugModel = function (a) {
      return {_: {},voteCount: a};
   };
   var DownvoteEvent = {ctor: "DownvoteEvent"};
   var UpvoteEvent = {ctor: "UpvoteEvent"};
   var NoOpEvent = {ctor: "NoOpEvent"};
   var FromEffect = {ctor: "FromEffect"};
   var kickOff = function ($) {
      return $Effects.task($Task.map($Basics.always(FromEffect))($Task.toMaybe($)));
   };
   ...
   model) {
      return function () {
         ...
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("row btn-group btn-group-justified")]),
         _L.fromArray([A2($Html.div,
                      _L.fromArray([$Html$Attributes.$class("col-xs-4")]),
                      _L.fromArray([A2($Html.button,
                      _L.fromArray([A2($Html$Events.onClick,
                                   guiAddress,
                                   DownvoteEvent)
                                   ,$Html$Attributes.$class("btn btn-default btn-block")]),
                      _L.fromArray([A2($Html.span,
                      _L.fromArray([$Html$Attributes.$class("glyphicon glyphicon-arrow-down")]),
                      _L.fromArray([]))]))]))
                      ,A2($Html.div,
                      _L.fromArray([$Html$Attributes.$class("col-xs-4 text-center")]),
                      _L.fromArray([$Html.text($Basics.toString(augModel.voteCount))]))
                      ,A2($Html.div,
                      _L.fromArray([$Html$Attributes.$class("col-xs-4")]),
                      _L.fromArray([A2($Html.button,
                      _L.fromArray([A2($Html$Events.onClick,
                                   ...
                                   ,$Html$Attributes.$class("btn btn-default btn-block")]),
                      _L.fromArray([A2($Html.span,
                      _L.fromArray([$Html$Attributes.$class("glyphicon glyphicon-arrow-up")]),
                      _L.fromArray([]))]))]))]));
      }();
   });
   var initialModel = {_: {}
   ...
   var firebaseUrl = "https://collab-counter.firebaseio.com/counter0";
   var syncConfig = {_: {}
                    ,decoder: $Json$Decode.oneOf(_L.fromArray([A2($Json$Decode.map,
                                                              Upvote,
                                                              A2($Json$Decode._op[":="],
                                                              "upvote",
                                                              $Json$Decode.$int))
   ...
   var $ = $ElmFire$Dict.mirror(syncConfig),
   initialTask = $._0,
   inputVotes = $._1;
   var initialEffect = kickOff(initialTask);
   var effectVotes = function (operation) {
         ...
         {case "FromEffect":
            ...
            switch (action._0.ctor)
              {case "DownvoteEvent":
                 return {ctor: "_Tuple2"
                        ,_0: model
                        ,_1: effectVotes($ElmFire$Op.push(Downvote(1)))};
                 case "UpvoteEvent":
                 return {ctor: "_Tuple2"
                        ,_0: model
                        ,_1: effectVotes($ElmFire$Op.push(Upvote(1)))};}
              break;
            case "FromServer":
            return {ctor: "_Tuple2"
                   ,_0: _U.replace([["votes"
   ...
   _elm.Main.values = {_op: _op
                      ...
                      ,inputVotes: inputVotes
                      ,initialEffect: initialEffect
                      ,kickOff: kickOff
                      ,effectVotes: effectVotes
